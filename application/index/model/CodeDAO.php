...
import('phpqrcode',VENDOR_PATH.'/phpqrcode/','.php');
...
class CodeDAO
{
     ...
     * @return bool
     */
    public function TwoCodePng($content,$address,$level,$pointsize,$padding){
        $level = ($level)?:$this->errorCorrectionLevel;
        $pointsize = ($pointsize)?:$this->matrixPointSize;
        $padding = ($padding)?:$this->padding;
        QRcode::png($content, $address, $level, $pointsize, $padding);
     ...
     * @return bool
     */
    public function TwoCodePngLogo($content,$address,$logo,$level,$pointsize,$padding){
        $level = ($level)?:$this->errorCorrectionLevel;
        $pointsize = ($pointsize)?:$this->matrixPointSize;
        $padding = ($padding)?:$this->padding;
        QRcode::png($content,$address,$level,$pointsize,$padding,true);
        $QR = imagecreatefromstring(file_get_contents($address));
