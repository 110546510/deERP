...
CREATE TABLE `d_organization` (
  ...
  `status` char(1) DEFAULT '0' COMMENT '状态0存在1删除',
  PRIMARY KEY (`id`),
  UNIQUE KEY `one` (`name`),
  KEY `belong` (`belong`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
insert  into `d_organization`(`id`,`name`,`belong`,`number`,`who`,`status`) values ('C-111','公司','1','1','0','0'),('ST-1555845074499','时尚部','c-1111',NULL,'0','0');
