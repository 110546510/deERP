...
CREATE TABLE `d_organization` (
  ...
  `belong` varchar(30) DEFAULT NULL COMMENT '上级',
...
insert  into `d_organization`(`id`,`name`,`belong`,`number`,`who`) values ('C-111','公司','1','1','0');
...
CREATE TABLE `d_staff_clock` (
  ...
  `to_work_info` char(1) NOT NULL DEFAULT '0',
  `off_work_info` char(1) NOT NULL,
